...
conferences = Conference.create!([{ name: 'GoRuCo', start_date: DateTime.new(2011,2,3), end_date: DateTime.new(2011,2,5), slug: 'goruco-2011' },
                                  ...
                                  { name: 'gSchool Demos', start_date: DateTime.new(2013,6,27), end_date: DateTime.new(2011,6,28), slug: 'gschool-demo-2013' },
                                  { name: 'Pitches and Pitchers', start_date: DateTime.new(2013,7,2), end_date: DateTime.new(2013,7,2), slug: 'pitches-and-pitchers-2013' },
                                  { name: 'Code for Communities', start_date: DateTime.new(2011,7,2), end_date: DateTime.new(2011,7,2), slug: 'code-for-communities-2013' },
...
sessions = Session.create!([{ track_id: 1, title: 'Refactoring Classes', description: 'Make your classes leaner', speaker: 'Katrina Owen', location: 'Room 413' },
                          ...
                          { track_id: 5, title: 'BackChannel', description: 'Enhancing the conference experience with chat, Q&A, and schedule', speaker: 'Raph, Jen, Kareem, Phil', location: 'Conference Room East'},
                          { track_id: 5, title: 'Traveline', description: 'Making group travel more interactive', speaker: 'gSchool students', location: 'Conference Room East'},
                          { track_id: 5, title: 'Trivia', description: 'Play against your friends at the bar', speaker: 'gSchool students', location: 'Conference Room East'},
