...
sessions = Session.create!([{ track_id: 1, title: 'Refactoring Classes', description: 'Make your classes leaner', speaker: 'Katrina Owen', location: 'Room 413', start_time: DateTime.new(2013,11,8,9), end_time: DateTime.new(2013,11,8,10) },
                            ...
                            { track_id: 1, title: 'Refactoring Controllers', description: 'Keep your controllers concise', speaker: 'TBD', location: 'Room 413', start_time: DateTime.new(2013,11,8,11).strftime('%l:%M'), end_time: DateTime.new(2013,11,8,12).strftime('%l:%M') },
                            { track_id: 1, title: 'Refactoring Models', description: 'Make your models clear and readable', speaker: 'Aaron Patterson', location: 'Room 413', start_time: DateTime.new(2013,11,8,14).strftime('%l:%M'), end_time: DateTime.new(2013,11,8,15).strftime('%l:%M') }
                            ...
                            { track_id: 10, title: 'Refactoring Classes', description: 'Make your classes leaner', speaker: 'Katrina Owen', location: 'Room 413', start_time: DateTime.new(2013,11,8,9), end_time: DateTime.new(2013,11,8,10) },
                            { track_id: 10, title: 'Refactoring Methods', description: 'Make your methods clear', speaker: 'Frank Weber', location: 'Room 413', start_time: DateTime.new(2013,11,8,10), end_time: DateTime.new(2013,11,8,11) },
                            { track_id: 10, title: 'Refactoring Controllers', description: 'Keep your controllers concise', speaker: 'TBD', location: 'Room 413', start_time: DateTime.new(2013,11,8,11), end_time: DateTime.new(2013,11,8,12) },
                            { track_id: 10, title: 'Refactoring Models', description: 'Make your models clear and readable', speaker: 'Aaron Patterson', location: 'Room 413', start_time: DateTime.new(2013,11,8,14), end_time: DateTime.new(2013,11,8,15) }
                            ...
                            { track_id: 5, title: 'BackChannel II', description: 'Enhancing the conference experience with chat, Q&A, and schedule', speaker: 'Raph, Jen, Kareem, Phil', location: 'Conference Room East', start_time: DateTime.new(2013,11,8,9), end_time: DateTime.new(2013,11,8,10) },
                            { track_id: 5, title: 'Traveline II', description: 'Making group travel more interactive', speaker: 'gSchool students', location: 'Conference Room East', start_time: DateTime.new(2013,11,8,10), end_time: DateTime.new(2013,11,8,11) },
                            { track_id: 5, title: 'Trivia II', description: 'Play against your friends at the bar', speaker: 'gSchool students', location: 'Conference Room East', start_time: DateTime.new(2013,11,8,11), end_time: DateTime.new(2013,11,8,12) },
